...
Codecov integration was done via the [Codecov GitHub app](https://github.com/apps/codecov). Besides the information available on the [Codecov web app](https://app.codecov.io/gh/edumserrano/markdown-link-check-log-parser), this integration enables Codecov to:
...
This workflow uses a Dependabot secret as well as a Repository secret named `CODECOV_TOKEN`. This secret contains a [token from Codecov](https://app.codecov.io/gh/edumserrano/markdown-link-check-log-parser/settings) with permissions to upload [code coverage to Codecov](https://app.codecov.io/gh/edumserrano/markdown-link-check-log-parser).
